...
#SBATCH --output=/storage/hpc/41/dolamull/experiments/uk-case-retrieval/jina_output.log
#SBATCH --error=/storage/hpc/41/dolamull/experiments/uk-case-retrieval/jina_error.log
...
python -m experiments.training.single_paragraph_transformer --model_name=jinaai/jina-embeddings-v2-base-en \
